...
async function run(URL){
    try{
        ...
        console.log(extractHtml.Url())
    
        // const rawJSON = {selectors, rawHtml: await extractHtml.rawHtml(), urls: await extractHtml.Links()}
        const rawJSON = {urls: await extractHtml.Links()}
